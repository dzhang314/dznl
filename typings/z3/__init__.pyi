...
def And(a: BoolRef, b: BoolRef, *c: BoolRef) -> BoolRef: ...
def Or(a: BoolRef, b: BoolRef, *c: BoolRef) -> BoolRef: ...
...
class ArithRef(object):
    ...
    def __radd__(self, other: int | ArithRef) -> ArithRef: ...
    def __sub__(self, other: int | ArithRef) -> ArithRef: ...
    def __rsub__(self, other: int | ArithRef) -> ArithRef: ...
    def sexpr(self) -> str: ...
